...
const isAdminOrCreator = computed(() => userRole.value === 'admin' || userRole.value === 'creator')
    ...
    <nav class="bg-white shadow-md relative z-10">
      <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex md:space-x-6">
          ...
          <div v-if="isAdminOrCreator" class="relative">
            ...
            >
              <span>{{ isAdmin ? 'Admin' : 'Creator' }}</span>
            ...
            <div
              ...
              <!-- Manage Feedback (admin and creator) -->
              <RouterLink v-if="isAdmin" @click="closeMenu" to="/admin/feedback" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                <div class="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <RouterLink v-if="isAdmin" @click="closeMenu" to="/admin/users" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                <div class="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <!-- Admin/Creator Section (Mobile) -->
          <div v-if="isAdminOrCreator" class="px-3 py-2">
            <div class="flex items-center text-base font-medium text-gray-600 mb-1">
              <span>{{ isAdmin ? 'Admin' : 'Creator' }}</span>
